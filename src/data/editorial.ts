/**
 * Editorial — LIQZAR's story-led content hub.
 * Articles here power the /editorial index and /editorial/:slug detail pages,
 * and feed the homepage "Sip Stories" teaser. Premium customers (LSM 9-10)
 * convert on narrative, not price — this is the lust engine.
 *
 * To add a story: append to EDITORIAL_ARTICLES with a unique slug.
 * Future: replace with Supabase `editorial_articles` table + CMS.
 */
...
export const getEditorialBySlug = (
  slug: string,
